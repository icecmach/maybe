...
name: Bug report
about:
  Open a bug report when you experience broken functionality within the latest
  version of the Aurabok app
...
- [ ] I have searched [existing issues](https://github.com/icecmach/aurabok/issues?q=is:issue) and [discussions](https://github.com/icecmach/aurabok/discussions) to ensure this is not a duplicate issue

### How are you using Aurabok?

- [ ] I am a paying Aurabok customer (hosted version)
  - Paying Aurabok users can also open requests in Intercom (if there is sensitive info involved)
...
- Self hosted app commit SHA (find in user menu): [enter commit sha here]
  - [ ] I have confirmed that my app's commit is the latest version of Aurabok
...
Be as specific as possible so Aurabok maintainers can quickly reproduce the bug you're experiencing.
