# Create OAuth applications for Aurabok's first-party apps
# These are the only OAuth apps that will exist - external developers use API keys

# Aurabok iOS App
ios_app = Doorkeeper::Application.find_or_create_by(name: "Aurabok iOS") do |app|
  app.redirect_uri = "aurabok://oauth/callback"
