# Contributing to Aurabok

It means so much that you're interested in contributing to Aurabok! Seriously. Thank you. The entire community benefits from these contributions!

## House Rules

- Before contributing, familiarize yourself with our project conventions. You should read through our [Project Conventions Rule](https://github.com/icecmach/aurabok/.cursor/rules/project-conventions.mdc), which is intended for LLMs, but is also an excellent primer on how we write code for Aurabok.
...
- Before contributing, please check if it already exists in [issues](https://github.com/icecmach/aurabok/issues) or [PRs](https://github.com/icecmach/aurabok/pulls)
...
As we are still in the early days of this project, we recommend [heading over to the Wiki](https://github.com/icecmach/aurabok/wiki) to get a better idea of _what_ to contribute.

In general, _full features_ that get us closer to [our Vision](https://github.com/icecmach/aurabok/wiki/Vision) are the most valuable contributions at this stage.
...
2. Local Development
   - [Mac Setup Guide](https://github.com/icecmach/aurabok/wiki/Mac-Dev-Setup-Guide)
   - [Linux Setup Guide](https://github.com/icecmach/aurabok/wiki/Linux-Dev-Setup-Guide)
   - [Windows Setup Guide](https://github.com/icecmach/aurabok/wiki/Windows-Dev-Setup-Guide)
